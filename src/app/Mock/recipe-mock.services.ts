...
export const RecipeMock: ListItem[] =
  ...
  [
    new ListItem(102, "Biscotti Mandorle", JSON.parse(sessionStorage.getItem('user')), "../../assets/img/carne.jpeg", ListItem1, false, "descrizione1"),
    new ListItem(103, "Torta al Limone", JSON.parse(sessionStorage.getItem('user')), "../../assets/img/carne.jpeg", ListItem2, false, "descrizione2"),
    new ListItem(104, "Tacchino ripieno", JSON.parse(sessionStorage.getItem('user')), "../../assets/img/carne.jpeg", ListItem3, false, "descrizione3")
  ]
